...
@Entity
@Table(name = "msg_chatroom", schema = "kampus_old", catalog = "")
public class MsgChatroomEntity {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        MsgChatroomEntity that = (MsgChatroomEntity) o;
        return id == that.id &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, name, avatarPhotoId, userHolderId);
    }
    ...
    @OneToMany(mappedBy = "msgChatroomByChatroomRecipientId")
    ...
    @OneToMany(mappedBy = "msgChatroomByChatroomId")
