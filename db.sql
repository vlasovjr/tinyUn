...
-- -----------------------------------------------------
-- Table `kampus_old`.`department`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kampus_old`.`department` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `kampus_old`.`teacher` (
  ...
  CONSTRAINT `department_id__fk_teacher`
    ...
    REFERENCES `kampus_old`.`department` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kampus_old`.`student_group_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kampus_old`.`student_group_info` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `student_id_starosta__fk_sgi`
    ...
    REFERENCES `kampus_old`.`student` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kampus_old`.`student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kampus_old`.`student` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `student_group_info_id__fk_student`
    ...
    REFERENCES `kampus_old`.`student_group_info` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `kampus_old`.`student_transcript_info`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kampus_old`.`student_transcript_info` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kampus_old`.`student_transcript_field`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kampus_old`.`student_transcript_field` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `student_transcript_info_id__fk_stf`
    ...
    REFERENCES `kampus_old`.`student_transcript_info` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `kampus_old`.`notification_student_transcript` (
  ...
  CONSTRAINT `student_transcript_content_id__fk_nst`
    ...
    REFERENCES `kampus_old`.`student_transcript_field` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tinyUnDB`.`table3`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tinyUnDB`.`table3` (
)
ENGINE = InnoDB;
...
INSERT INTO `kampus_old`.`user_account__old` (`id`, `login`, `password`, `role_id`, `first_name`, `second_name`, `photo_avatar_id`) VALUES (, 'kill', 'me', 1, 'fuck', 'you', NULL);
