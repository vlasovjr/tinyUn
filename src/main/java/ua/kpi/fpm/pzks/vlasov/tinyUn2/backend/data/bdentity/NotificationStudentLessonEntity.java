...
@Entity
@Table(name = "notification_student_lesson", schema = "kampus_old", catalog = "")
public class NotificationStudentLessonEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        NotificationStudentLessonEntity that = (NotificationStudentLessonEntity) o;
        return id == that.id &&
